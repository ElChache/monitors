...
>
  ...
  <div class="monitor-actions">
    <button class="action-btn primary" on:click={onView} aria-label="View detailed chart for {title}"> View </button>
    <button class="action-btn secondary" on:click={onConfig} aria-label="Configure {title}"> Config </button>
  </div>
</div>
