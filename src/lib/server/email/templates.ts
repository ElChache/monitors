import { db } from '../db';
import { emailNotifications, emailUnsubscribes } from '../../db/schemas/notifications';
...
export class EmailTemplateRenderer {
   ...
   */
  static renderTemplate(templateName: string, data: Record<string, any>): {
    subject: string;
    html: string;
    text: string;
  } {
...
/**
 * Email notification tracking service
 */
export class EmailTrackingService {
   ...
   */
  static async isUnsubscribed(userId: string, notificationType: string): Promise<boolean> {
    try {
   ...
   */
  static async unsubscribe(userId: string, notificationType: string): Promise<boolean> {
    try {
   ...
   */
  static generateUnsubscribeUrl(userId: string, notificationType: string): string {
   ...
   */
  static parseUnsubscribeToken(token: string): { userId: string; notificationType: string } | null {
    try {
