...
import { EmailTemplateRenderer } from '$lib/server/email/templates';

// POST /api/email/test - Test email service functionality (development only)
...
// GET /api/email/test - Get email service status and configuration
