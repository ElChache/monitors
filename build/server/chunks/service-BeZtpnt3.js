...
import { u as users, m as monitors, s as sessions } from './users-CCLvGjXf.js';
import { eq, count, and, desc, gte } from 'drizzle-orm';
import './service2-D_Iyu9gC.js';
...
class AdminService {
  ...
  static async getServiceHealth() {
    ...
    try {
      const { redis } = await import('./connection-D27Xdyu3.js');
      await redis.ping();
      results.redis = true;
    } catch {
      results.redis = false;
...
export { AdminService as A };
//# sourceMappingURL=service-BeZtpnt3.js.map
